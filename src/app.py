...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training, technique improvement and local meets",
    ...
    "Debate Team": {
        "description": "Competitive debating, public speaking, and tournaments",
...
def remove_participant(activity_name: str, email: str):
    """Remove a participant from an activity by email (query parameter `email`)."""
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
    ...
    # Find participant by normalized comparison
